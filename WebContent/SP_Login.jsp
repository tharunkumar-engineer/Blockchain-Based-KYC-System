...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2"><span class="style24">Welcome To Service Provider Login </span></h2>
            ...
            <table width="443" align="center" cellpadding="0" cellspacing="2">
              ...
              <tr>
                ...
                <td><span class="style19">
                  ...
                  <span class="style33">New User?</span></span><a href="SP_Register.jsp" class="style20"> Register </a></td>
              </tr>
            </table>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu"><li><p><a href="index.html">Home</a></p>
