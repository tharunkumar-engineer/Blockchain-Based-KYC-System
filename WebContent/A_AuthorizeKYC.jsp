...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2"><span class="style50">View Users and Authorize  KYC!!! </span></h2>
          <p class="infopost">&nbsp;</p>
		  ...
		  <table width="749" align="center"  cellpadding="0" cellspacing="0">
			...
			<td width="80" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style5 style57 style27 style100 style55">Aadhaar Number</div></td>
			<td width="90" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style5 style57 style27 style100 style55">PAN</div></td>
			<td width="100" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style5 style57 style27 style100 style55">Location</div></td>
            ...
            <%
						...
						try 
						{
						   	String query="select * from userKYC"; 
            ...
            <tr>
              ...
              <td  rowspan="1" align="center" valign="middle" ><div class="style54 style97 style86 style37 style5" style="margin:10px 13px 10px 13px;" ><strong>
                  <input  name="image" type="image" src="images.jsp?value=<%="userkyc"%>&amp;id=<%=i%>" style="width:120px; height:100px;" />
              </strong></div></td>
              ...
              <td valign="middle"  style="color:#000000;"align="center"><div align="center" class="style20 style30 style37 style86 style97 style54 style56">
                  <div align="center"><a href="Authentication.jsp?value=<%="userskyc"%>&amp;id=<%=i%>" class="style29 style98">waiting</a></div>
              </div></td>
              <%
						}
						else
